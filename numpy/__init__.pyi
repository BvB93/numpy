...
_Unit = TypeVar("_Unit", contravariant=True, bound=TimeUnit)
_CharType = TypeVar("_CharType", bound=Union[str, bytes])

_TD64Value = Union[None, int, _CharLike, dt.timedelta, timedelta64[Any]]
_DT64Value = Union[None, int, _CharLike, dt.timedelta, datetime64[Any]]
...
class datetime64(generic, Generic[_Unit]):
    ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Union[bytes, str_]]) -> datetime64[Any]: ...
    @overload
...
class timedelta64(generic, Generic[_Unit]):
    ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Union[bytes, str_]]) -> timedelta64[Any]: ...
    @overload
    ...
    def __mul__(self, other: Union[_FloatLike, _BoolLike]) -> timedelta64[_Unit]: ...
    def __rmul__(self, other: Union[_FloatLike, _BoolLike]) -> timedelta64[_Unit]: ...

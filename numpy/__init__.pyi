...
_Unit = TypeVar("_Unit", covariant=True, bound=TimeUnit)
_CharType = TypeVar("_CharType", bound=Union[str, bytes])

_TD64Value = Union[None, int, timedelta64[Any], _CharLike, dt.timedelta]
_DT64Value = Union[None, int, datetime64[Any], _CharLike, dt.datetime]
_TimeFormat = Union[_CharType, Tuple[_CharType, _IntLike]]

class datetime64(generic, Generic[_Unit]):
    @overload
    def __new__(cls, __value: Union[None, _CharLike, dt.datetime]) -> datetime64[Any]: ...
    @overload
    def __new__(cls, __value: datetime64[_Unit]) -> datetime64[_Unit]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["Y"]]) -> datetime64[_Y]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["M"]]) -> datetime64[_M]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["W"]]) -> datetime64[_W]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["D"]]) -> datetime64[_D]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["h"]]) -> datetime64[_h]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["m"]]) -> datetime64[_m]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["s"]]) -> datetime64[_s]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["ms"]]) -> datetime64[_ms]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["us"]]) -> datetime64[_us]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["ns"]]) -> datetime64[_ns]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["ps"]]) -> datetime64[_ps]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["fs"]]) -> datetime64[_fs]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[Literal["as"]]) -> datetime64[_as]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: _TimeFormat[bytes]) -> datetime64[Any]: ...
    @overload
    def __new__(cls, __value: _DT64Value, __format: str) -> datetime64[Any]: ...

    def __add__(self, other: _TD64Like[_Unit]) -> datetime64[_Unit]: ...
    def __radd__(self, other: _TD64Like[_Unit]) -> datetime64[_Unit]: ...
    @overload
    def __sub__(self, other: datetime64[_Unit]) -> timedelta64[_Unit]: ...
    @overload
    def __sub__(self, other: _TD64Like[_Unit]) -> datetime64[_Unit]: ...
    def __rsub__(self, other: datetime64[_Unit]) -> timedelta64[_Unit]: ...

class timedelta64(generic, Generic[_Unit]):
    @overload
    def __new__(cls, __value: Union[None, int, _CharLike, dt.timedelta]) -> timedelta64[Any]: ...
    @overload
    def __new__(cls, __value: timedelta64[_Unit]) -> timedelta64[_Unit]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["Y"]]) -> timedelta64[_Y]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["M"]]) -> timedelta64[_M]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["W"]]) -> timedelta64[_W]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["D"]]) -> timedelta64[_D]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["h"]]) -> timedelta64[_h]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["m"]]) -> timedelta64[_m]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["s"]]) -> timedelta64[_s]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["ms"]]) -> timedelta64[_ms]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["us"]]) -> timedelta64[_us]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["ns"]]) -> timedelta64[_ns]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["ps"]]) -> timedelta64[_ps]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["fs"]]) -> timedelta64[_fs]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[Literal["as"]]) -> timedelta64[_as]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: _TimeFormat[bytes]) -> timedelta64[Any]: ...
    @overload
    def __new__(cls, __value: _TD64Value, __format: str) -> timedelta64[Any]: ...
    ...
    def __pos__(self: _ArraySelf) -> _ArraySelf: ...
    def __abs__(self: _ArraySelf) -> _ArraySelf: ...
    def __add__(self, other: _TD64Like[_Unit]) -> timedelta64[_Unit]: ...
    def __radd__(self, other: _TD64Like[_Unit]) -> timedelta64[_Unit]: ...
    def __sub__(self, other: _TD64Like[_Unit]) -> timedelta64[_Unit]: ...
    def __rsub__(self, other: _TD64Like[_Unit]) -> timedelta64[_Unit]: ...
    def __mul__(self, other: _FloatLike) -> timedelta64[_Unit]: ...
    def __rmul__(self, other: _FloatLike) -> timedelta64[_Unit]: ...
    __truediv__: _TD64Div[_Unit, float64]
    __floordiv__: _TD64Div[_Unit, int64]
    def __rtruediv__(self, other: timedelta64[_Unit]) -> float64: ...
    def __rfloordiv__(self, other: timedelta64[_Unit]) -> int64: ...
    def __mod__(self, other: timedelta64[_Unit]) -> timedelta64[_Unit]: ...
    def __rmod__(self, other: timedelta64[_Unit]) -> timedelta64[_Unit]: ...
    def __divmod__(self, other: timedelta64[_Unit]) -> Tuple[int64, timedelta64[_Unit]]: ...
    def __rdivmod__(self, other: timedelta64[_Unit]) -> Tuple[int64, timedelta64[_Unit]]: ...

...
class dtype(Generic[_DTypeScalar_co]):
    ...
    def char(self) -> str: ...
    @property
    def descr(self: dtype[_SupportsDescr[_T]]) -> _T: ...  # type: ignore[type-var]
    @property
    def fields(self: dtype[_SupportsFields[_T]]) -> _T: ...  # type: ignore[type-var]
    @property
    def flags(self) -> int: ...
    @property
    def hasobject(self: dtype[_SupportsHasObject[_T]]) -> _T: ...  # type: ignore[type-var]
    @property
    def isbuiltin(self: dtype[_SupportsIsBuiltin[_T]]) -> _T: ...  # type: ignore[type-var]
    @property
    def isnative(self) -> bool: ...
    @property
    def isalignedstruct(self: dtype[_SupportsIsAlignedStruct[_T]]) -> _T: ...  # type: ignore[type-var]
    @property
    def itemsize(self: dtype[_SupportsItemSize[_T]]) -> _T: ...  # type: ignore[type-var]
    @property
    def kind(self: dtype[_SupportsKind[_T]]) -> _T: ...   # type: ignore[type-var]
    @property
    def metadata(self) -> None | MappingProxyType[str, Any]: ...
    @property
    def name(self: dtype[_SupportsName[_T]]) -> _T: ...  # type: ignore[type-var]
    @property
    def names(self: dtype[_SupportsNames[_T]]) -> _T: ...  # type: ignore[type-var]
    @names.setter
    def names(self: dtype[_SupportsNames[_T]], value: _T) -> None: ...  # type: ignore[type-var]
    @property
    def num(self) -> int: ...
    @property
    def shape(self: dtype[_SupportsShape[_T]]) -> _T: ...  # type: ignore[type-var]
    @property
    def ndim(self: dtype[_SupportsNDim[_T]]) -> _T: ...  # type: ignore[type-var]
    @property
    def subdtype(self: dtype[_SupportsSubDType[_T]]) -> _T: ...  # type: ignore[type-var]
...
class generic(_ArrayOrScalarCommon):
    ...
    # NOTE: In practice this information is stored in the dtype and
    # not the generic, but as it is currently impossible to overload
    # properties the best we can do is store the info in generic
    # and retrieve it via protocols.
    # Note that these methods are purely type-check-only implementation
    # details and are unavailable at runtime
    def _has_object(self) -> bool: ...
    def _isbuiltin(self) -> int: ...
    def _isalignedstruct(self) -> bool: ...
    def _itemsize(self) -> int: ...
    def _kind(self) -> str: ...
    def _name(self) -> str: ...
    def _names(self) -> None | Tuple[str, ...]: ...
    def _fields(self) -> None | MappingProxyType[
        str,
        Tuple[dtype[Any], int] | Tuple[dtype[Any], int, Any],
    ]: ...
    def _descr(self) -> List[Any]: ...
    def _ndim(self) -> int: ...
    def _shape(self) -> _Shape: ...
    def _subdtype(self) -> None | Tuple[dtype[Any], _Shape]: ...
...
class number(generic, Generic[_NBit1]):  # type: ignore
    ...
    def _has_object(self) -> L[False]: ...
    def _isbuiltin(self) -> L[1]: ...
    def _isalignedstruct(self) -> L[False]: ...
    def _names(self) -> None: ...
    def _fields(self) -> None: ...
    def _descr(self) -> List[Tuple[L[""], str]]: ...
    def _ndim(self) -> L[0]: ...
    def _shape(self) -> Tuple[()]: ...
    def _subdtype(self) -> None: ...
...
class bool_(generic):
    ...
    def _isbuiltin(self) -> L[1]: ...
    def _isalignedstruct(self) -> L[False]: ...
    def _itemsize(self) -> L[1]: ...
    def _kind(self) -> L["b"]: ...
    def _name(self) -> L["bool"]: ...
    def _names(self) -> None: ...
    def _fields(self) -> None: ...
    def _descr(self) -> List[Tuple[L[""], str]]: ...
    def _ndim(self) -> L[0]: ...
...
class object_(generic):
    ...
    def _has_object(self) -> L[True]: ...
    def _isbuiltin(self) -> L[1]: ...
    def _isalignedstruct(self) -> L[False]: ...
    def _itemsize(self) -> L[8]: ...
    def _kind(self) -> L["O"]: ...
    def _name(self) -> L["object"]: ...
    def _names(self) -> None: ...
    def _fields(self) -> None: ...
    def _descr(self) -> List[Tuple[L[""], str]]: ...
    def _ndim(self) -> L[0]: ...
...
class void(flexible):
    ...
    def _kind(self) -> L["V"]: ...
    def _descr(self) -> List[Tuple[str, str] | Tuple[str, str, _Shape]]: ...

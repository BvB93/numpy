...
class chararray(ndarray):
    def __new__(
        ...
        itemsize: int = ...,
        unicode: bool = ...,
        buffer: Union[None, str, _BufferType] = ...,
        offset: int = ...,
        strides: Optional[_ShapeLike] = ...,
        order: Optional[str] = ...,
    ) -> _ArraySelf: ...
    def capitalize(self: _ArraySelf) -> _ArraySelf: ...
    def center(self: _ArraySelf, width: int, fillchar: str = ...) -> _ArraySelf: ...
    def count(
        self: _ArraySelf, sub: str, start: int = ..., end: Optional[int] = ...
    ) -> _ArraySelf: ...
    def decode(
        self: _ArraySelf, encoding: Optional[str] = ..., errors: Optional[str] = ...
    ) -> _ArraySelf: ...
    def encode(
        self: _ArraySelf, encoding: Optional[str] = ..., errors: Optional[str] = ...
    ) -> _ArraySelf: ...
    def endswith(
        self: _ArraySelf, suffix: str, start: int, end: Optional[int] = ...
    ) -> _ArraySelf: ...
    def expandtabs(self: _ArraySelf, tabsize: int = ...) -> _ArraySelf: ...
    def find(
        self: _ArraySelf, sub: str, start: int = ..., end: Optional[int] = ...
    ) -> _ArraySelf: ...
    def index(
    ...
    def isalnum(self: _ArraySelf) -> _ArraySelf: ...
    def isalpha(self: _ArraySelf) -> _ArraySelf: ...
    def isdecimal(self: _ArraySelf) -> _ArraySelf: ...
    def isdigit(self: _ArraySelf) -> _ArraySelf: ...
    def islower(self: _ArraySelf) -> _ArraySelf: ...
    def isnumeric(self: _ArraySelf) -> _ArraySelf: ...
    def isspace(self: _ArraySelf) -> _ArraySelf: ...
    def istitle(self: _ArraySelf) -> _ArraySelf: ...
    def isupper(self: _ArraySelf) -> _ArraySelf: ...
    def join(self: _ArraySelf, seq: ArrayLike) -> _ArraySelf: ...
    def ljust(self: _ArraySelf, width: str, fillchar: str = ...) -> _ArraySelf: ...
    def lower(self: _ArraySelf) -> _ArraySelf: ...
    def lstrip(self: _ArraySelf, chars: Optional[str] = ...) -> _ArraySelf: ...
    def partition(self: _ArraySelf, sep: str) -> _ArraySelf: ...
    def replace(
        self: _ArraySelf, old: str, new: str, count: Optional[int] = ...
    ) -> _ArraySelf: ...
    def rfind(
        self: _ArraySelf, sub: str, start: int = ..., end: Optional[int] = ...
    ) -> _ArraySelf: ...
    ...
    def rjust(self: _ArraySelf, width: int, fillchar: str = ...) -> _ArraySelf: ...
    def rpartition(self: _ArraySelf, sep: str) -> _ArraySelf: ...
    def rsplit(
        self: _ArraySelf, sep: Optional[str], maxsplit: Optional[int] = ...
    ) -> _ArraySelf: ...
    def rstrip(self: _ArraySelf, chars: Optional[str] = ...) -> _ArraySelf: ...
    def split(
        self: _ArraySelf, sep: Optional[str], maxsplit: Optional[int] = ...
    ) -> _ArraySelf: ...
    def splitlines(self: _ArraySelf, keepends: Optional[bool] = ...) -> _ArraySelf: ...
    def startswith(
        self: _ArraySelf, prefix: str, start: int, end: Optional[int]
    ) -> _ArraySelf: ...
    def strip(self: _ArraySelf, chars: Optional[str] = ...) -> _ArraySelf: ...
    def swapcase(self: _ArraySelf) -> _ArraySelf: ...
    def title(self: _ArraySelf) -> _ArraySelf: ...
    def translate(
        self: _ArraySelf, table: str, deletechars: Optional[str] = ...
    ) -> _ArraySelf: ...
    def upper(self: _ArraySelf) -> _ArraySelf: ...
    def zfill(self: _ArraySelf, width: int) -> _ArraySelf: ...

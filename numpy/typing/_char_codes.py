...
if TYPE_CHECKING or HAVE_LITERAL:
    ...
    _IntPCodes = Literal["intp", "int0", "p", "=p", "<p", ">p", "|p"]
    _IntCodes = Literal["long", "int", "int_", "l", "=l", "<l", ">l", "|l"]
    ...
    _UIntPCodes = Literal["uintp", "uint0", "P", "=P", "<P", ">P", "|P"]
    _UIntCodes = Literal["uint", "L", "=L", "<L", ">L", "|L"]
    _ULongLongCodes = Literal["ulonglong", "Q", "=Q", "<Q", ">Q", "|Q"]

    _HalfCodes = Literal["half", "e", "=e", "<e", ">e", "|e"]
    _SingleCodes = Literal["single", "f", "=f", "<f", ">f", "|f"]
    _DoubleCodes = Literal["double", "float", "float_", "d", "=d", "<d", ">d", "|d"]
    _LongDoubleCodes = Literal["longdouble", "longfloat", "g", "=g", "<g", ">g", "|g"]

    _CSingleCodes = Literal["csingle", "singlecomplex", "F", "=F", "<F", ">F", "|F"]
    _CDoubleCodes = Literal["cdouble", "complex", "complex_", "cfloat", "D", "=D", "<D", ">D", "|D"]
    _CLongDoubleCodes = Literal["clongdouble", "clongfloat", "longcomplex", "G", "=G", "<G", ">G", "|G"]

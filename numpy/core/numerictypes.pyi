...
@overload
def maximum_sctype(t: _DTypeLike[_SCT]) -> _SCT: ...
@overload
def maximum_sctype(t: DTypeLike) -> Any: ...
@overload
def maximum_sctype(t: _T) -> _T: ...

@overload
def issctype(rep: dtype[object_] | Type[object_]) -> L[False]: ...
@overload
def issctype(rep: dtype[Any] | Type[generic]) -> L[True]: ...
@overload
def issctype(rep: object) -> L[False]: ...

@overload
def obj2sctype(rep: _DTypeLike[_SCT], default: object = ...) -> _SCT: ...  # type: ignore[misc]
@overload
def obj2sctype(rep: DTypeLike, default: None = ...) -> None | Any: ...
@overload
def obj2sctype(rep: DTypeLike, default: _T) -> _T | Any: ...
@overload
...
@overload
def issubclass_(arg1: Type[Any], arg2: Type[Any] | Tuple[Type[Any], ...]) -> bool: ...
@overload
